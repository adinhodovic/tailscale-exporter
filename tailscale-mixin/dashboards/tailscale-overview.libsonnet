  ...
  grafanaDashboards+:: {
    ['%s.json' % dashboardName]:
      ...
      local variables = [
        ...
        defaultVariables.clusterTailscale,
        defaultVariables.namespaceTailscale,
        defaultVariables.jobTailscale,
              ...
              tbQueryOptions.transformation.withOptions(
                {
                  renameByName: {
                    ...
                    users_role_allowed_to_join_external_tailnets: 'Users Role Allowed To Join External Tailnets',
                    Value: 'Up',
                  },
                  indexByName: {
                    tailnet: 0,
                    ...
                    users_approval_on: 7,
                    users_role_allowed_to_join_external_tailnets: 8,
                    Value: 9,
                  },
                  includeByName: {
                    tailnet: true,
                    ...
                    users_role_allowed_to_join_external_tailnets: true,
                    Value: true,
                  },
                }
              ),
